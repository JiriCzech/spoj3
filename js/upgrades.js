        ...
        applyToScore: (baseScore, matchedTiles, state) => {
            ...
            if (state.upgradeFlags.ripperdocTarget) {
                ...
                if (targetUpgrade && typeof targetUpgrade.applyToScore === 'function') {
                    // It doesn't double exactly, just applies the function a second time on the already boosted score, or safely multiplier.
                    // Given the spec: "Apply that upgrade's applyToScore twice / Simplified: just return baseScore * 1.5 as a safe fallback"
